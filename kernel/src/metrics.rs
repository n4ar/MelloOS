...
pub mod timing {
    ...
    impl TimingStats {
        ...
        pub fn record_syscall(&self, latency_ns: u64) {
            self.syscall_latency_ns.fetch_add(latency_ns, Ordering::Relaxed);
        ...
        pub fn record_pty_read(&self, latency_ns: u64) {
            self.pty_read_latency_ns.fetch_add(latency_ns, Ordering::Relaxed);
        ...
        pub fn record_pty_write(&self, latency_ns: u64) {
            self.pty_write_latency_ns.fetch_add(latency_ns, Ordering::Relaxed);
        ...
        pub fn record_signal(&self, latency_ns: u64) {
            self.signal_latency_ns.fetch_add(latency_ns, Ordering::Relaxed);
        ...
        pub fn record_context_switch(&self, latency_ns: u64) {
            self.context_switch_latency_ns.fetch_add(latency_ns, Ordering::Relaxed);
        ...
        pub fn record_fork(&self, latency_ns: u64) {
            self.fork_latency_ns.fetch_add(latency_ns, Ordering::Relaxed);
        ...
        pub fn record_execve(&self, latency_ns: u64) {
            self.execve_latency_ns.fetch_add(latency_ns, Ordering::Relaxed);
